 ...
 *
 * AR.IO Gateway Optical Bridge Integration Tests
 *
 * Tests the optimistic caching flow with AR.IO Gateway:
 * 1. Upload data item
 * 2. Verify optical bridge notification
 * 3. Check AR.IO Gateway can serve the data
 */
