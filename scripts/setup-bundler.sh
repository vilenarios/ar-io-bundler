...
if [ "$ADVANCED_MODE" = true ]; then
    ...
    prompt "IN_FLIGHT_DATA_ITEM_TTL_SECS" "In-flight TTL (seconds)" "${IN_FLIGHT_DATA_ITEM_TTL_SECS:-60}"
...
IN_FLIGHT_DATA_ITEM_TTL_SECS=${CONFIG[IN_FLIGHT_DATA_ITEM_TTL_SECS]:-60}
